 ...
 */
public class SNDWebPart extends BodyWebPart<SNDWebPart.ElementCache>
{
    public SNDWebPart(WebDriver driver)
    {
        this(driver, 0);
    }

    public SNDWebPart(WebDriver driver, int index)
    {
        super(driver, "SND", index);
    }

    public SNDWebPart setInput(String value)
    {
